/*
 * Driver for Dynamixel AX-12, wrapped as YARP driver
...
// should be obtained from configuration files
//const unsigned char jointNumbers[] = {0x65, 0x74, 0x84, 0x66, 0x75, 0x85, 0x67, 0x76, 0x86, 0x6B, 0x77, 0x87, 0x6A, 0x68, 0x69, 0x6C};
...
class yarp::dev::DynamixelAX12FtdiDriver : public DeviceDriver, public IPositionControl, public ITorqueControl, public IEncoders
{
  ...
  */
  ...
  //bool open_old(yarp::os::Searchable& config);
  ...
  */
  ...
  bool setRefTorque(int,double);
  bool setRefTorques(const double *);
