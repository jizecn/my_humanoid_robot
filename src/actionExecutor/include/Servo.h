...
public:
	...
	Servo(std::string name, Type type, int hardwareId, int yarpId, double maxPos, double minPos, double defaultPos, double maxSpeed, double minSpeed, double defaultSpeed)
	{
		this->name = name;
		this->type = type;
