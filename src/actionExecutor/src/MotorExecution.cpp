...
bool MotorExecution::appendSequence(KasparSequence &seq)
{
    seqQueued = true;
    appendedSeq = seq;
    return true;
...
void MotorExecution::executeSequence()
{
	...
	double tempTorq = 1;
	std::cout << this->currentSeq.size() << std::endl;
